 ...
 */
abstract class StorageJsonGroupByTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->productsLg = [
            ...
            ['product_id' => 1, 'language_id' => 2, 'title' => 'Paper', 'description' => '180mg paper', 'options' => '{"price":2.5}'],
            ...
            ['product_id' => 3, 'language_id' => 1, 'title' => 'Leim', 'description' => '', 'options' => '{"price":8.3}'],
    ...
    {        
        $items = $this->storage->table('products_lg')
            ->groupBy('options->price')
            ->havingBetween('options->price', [6,9])
            ->get();
