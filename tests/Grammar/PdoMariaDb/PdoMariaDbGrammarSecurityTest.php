...
/**
 * PdoMariaDbGrammarSecurityTest
 */
class PdoMariaDbGrammarSecurityTest extends TestCase
{
    protected $tables;
    ...
    {
        $grammar = (new PdoMariaDbGrammar($this->tables))->table('products as in%valid')->select(['sku']);
    ...
    {
        $grammar = (new PdoMariaDbGrammar($this->tables))->table('products')->select(['sku', 'invalid']);
    ...
    {
        $grammar = (new PdoMariaDbGrammar($this->tables))->table('products')->select(['sku', 'title as in%valid']);
    ...
    {
        $grammar = (new PdoMariaDbGrammar($this->tables))->table('products')->select(['sku', 'title->en as in%valid']);
    ...
    {
        $grammar = (new PdoMariaDbGrammar($this->tables))->table('products')->select(['sku->in%valid']);
